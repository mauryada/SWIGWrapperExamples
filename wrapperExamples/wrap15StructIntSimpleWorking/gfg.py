...
class foo(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["a"] = _gfg.foo_a_set
    __swig_getmethods__["a"] = _gfg.foo_a_get
    if _newclass:
        a = _swig_property(_gfg.foo_a_get, _gfg.foo_a_set)
    ...
    def __init__(self):
        ...
        try:
            ...
            self.this = this
    __swig_destroy__ = _gfg.delete_foo
    __del__ = lambda self: None
foo_swigregister = _gfg.foo_swigregister
