...
SWIGINTERN PyObject *_wrap_populate_a(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "populate_a", 0, 0, 0)) SWIG_fail;
  populate_a();
...
SWIGINTERN PyObject *_wrap_a_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "a_set", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "populate_a", _wrap_populate_a, METH_NOARGS, NULL},
	 { "a_set", _wrap_a_set, METH_VARARGS, NULL},
	 { "a_get", _wrap_a_get, METH_O, NULL},
	 ...
	 { "int_array", _wrap_int_array, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
